...
public int overallScore()
{
   ...
   if (score1 < score2 && score1 < score3) {
      ...
      s1 = score1;
      s2 = score3; //changed this from score2 to score3
   } else if (score3 < score1 && score3 < score2) {
      s1 = score1;
      s2 = score2;
   } else {
      s1 = score1; //changed this to take two of the three equivalent scores.
      s2 = score2;
   }
   s = s1 + s2;
   return s;
...
{
   int s1, s2, s3;
   if (args.length != 3) { //took out the case for null.
